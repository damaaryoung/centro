...
$('#update_verifikasi_data').click(function () {
  Swal.fire({
    ...
    if (result.value) {
      ...
      let notes_nasabah = $('#note_verifikasi_nasabah').val()
      let notes_jaminan = $('#note_verifikasi_jaminan').val()
      let notes_legal = $('#note_verifikasi_legal').val()
      let notes_spk = $('#note_verifikasi_spk').val()
      let notes_permohonan = $('#note_verifikasi_premohonan_kredit').val()
      let notes_bi = $('#note_verifikasi_bi_checking').val()
      let notes_ca = $('#note_verifikasi_credit_analist').val()
      let notes_foto = $('#note_verifikasi_foto').val()
      ...
      switch (menu_title) {
        ...
        case 'Verifikasi':
          data = {
            ...
            verifikasi_legal: verifikasi_legal,
            verifikasi_spk: verifikasi_spk,
            notes_nasabah: ((notes_nasabah == '') ? null : notes_nasabah),
            notes_permohonan: ((notes_permohonan == '') ? null : notes_permohonan),
            notes_bi: ((notes_bi == '') ? null : notes_bi),
            notes_ca: ((notes_ca == '') ? null : notes_ca),
            notes_foto: ((notes_foto == '') ? null : notes_foto),
            notes_jaminan: ((notes_jaminan == '') ? null : notes_jaminan),
            notes_legal: ((notes_legal == '') ? null : notes_legal),
            notes_spk: ((notes_spk == '') ? null : notes_spk)
          }
          break;
      }
  ...
  $.ajax({
    ...
    success: function (respon) {
      ...
      Swal.fire({
        ...
        if (result.value) {
          getDetailDataNasabah_to_FormEfiling(no_rekening, page_load, menu_title);
          Swal.fire({
            position: 'center',
            icon: 'success',
            title: 'Data Berhasil Di Perbarui',
