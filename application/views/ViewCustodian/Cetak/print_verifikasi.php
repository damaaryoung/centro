...
<html>
    <body>
           <img src="<?php echo base_url('assets/design/images/headOL.png') ?>" style="width: 500px;
            ...
            <h2 style="text-align: center;"><span style="text-decoration: underline;"><strong>TANDA TERIMA PENGAJUAN PEMINDAHAN JAMINAN</strong></span></h2>
            ...
            <p style="font-size: 12px;">Pemindahan Jaminan Antar Kantor dari: <?php echo $nama_kantor_lokasi_jaminan;?> ke <?php echo $nama_kantor_tujuan;?>, dengan perincian sebagai berikut :</p>
