...
<script type="text/javascript" src="<?php echo base_url();?>assets/design/js/select2.full.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Setting Dashboard Rasio Master
        <small></small>
      </h1>
    ...
    <section class="content container-fluid">
        ...
        <!-- From card Atas -->
          ...
          <div class="card card-danger">
                  ...
                  <div class="card-body">
                                          ...
                                          <div class="form-group row">
                                              <div class="col-sm-5">
                                                  <button type="button" class="btn btn-success btn-sm" 
                                                          style="width: 250px;" id="btn_add_rasio">
                                                            <i class="fas fa-plus-circle"></i> Rasio
                                                  </button>
                                              </div>
                                              <div class="col-sm-5">
                                              </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_rasio_master" class="table table-striped table-bordered" style="width:100% text-align:center" >
                                        ...
                                        <tbody id="tbl_body_rasio_master">
                                        </tbody>
                                    </table>
                                </div>
                                <br>    
          ...
          <!-- INSERT -->
          <div class="modal" id="modal_rasio"> 
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      <div class="modal-header">
                          <h4 class="modal-title">Rasio Master</h4>
                      ...
                      <div class="modal-body" style="height: 275px;">
                        <div class="row" style="padding-top: 20px;">
                                    ...
                                    <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Kode Perk 1</label>
                                          <div class="col-sm-8">
                                            <input placeholder="Kode Perk 1" name="modal_kode_perk1" id="modal_kode_perk1" type="text"  class ="form-control">
                                          </div>
                                    </div>
                                    <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Kode Perk 2</label>
                                          <div class="col-sm-8">
                                            <input placeholder="Kode Perk 2" name="modal_kode_perk2" id="modal_kode_perk2" type="text"  class ="form-control">
                                          </div>
                                    </div>
                                    <div class="form-group row">
...
<!-- Modal Update -->
          <div class="modal " id="modal_rasio_update"> 
          <div class="modal-dialog modal-dialog-centered">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Update Rasio Master</h4>
                ...
                <div class="row" style="padding-top: 20px;">
                              ...
                              <div class="col-md-12 mx-auto">
                                    ...
                                    <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Kode Perk 1</label>
                                          <div class="col-sm-8">
                                            <input placeholder="Kode Perk 1" name="modal_kode_perk1_update" id="modal_kode_perk1_update" type="text"  class ="form-control">
                                          </div>
                                    </div>
                                    <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Kode Perk 2</label>
                                          <div class="col-sm-8">
                                            <input placeholder="Kode Perk 2" name="modal_kode_perk2_update" id="modal_kode_perk2_update" type="text"  class ="form-control">
                                          </div>
                                    </div>
                                    <div class="form-group row">
                                          <label class="col-sm-4 col-form-label">Flag Mutasi</label>
...
<?php $this->view('ViewAccounting/js/rasio_setting_master_js.php'); ?>
<style>
              /* Important part */
              .modal-dialog{
