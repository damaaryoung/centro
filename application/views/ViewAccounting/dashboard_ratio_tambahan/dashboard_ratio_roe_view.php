...
<script type="text/javascript" src="<?php echo base_url();?>node_modules/chart.js/dist/jspdf.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h4> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Ratio Dashboard ROE
      </h4>
      <ol class="breadcrumb">
...
<?php $this->view('ViewAccounting/js/dashboard_ratio_tambahan/dashboard_ratio_roe_js.php'); ?>
