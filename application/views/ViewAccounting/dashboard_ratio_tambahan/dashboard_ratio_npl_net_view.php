...
<script type="text/javascript" src="<?php echo base_url();?>node_modules/chart.js/dist/jspdf.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h4> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Ratio Dashboard NPL NET
      </h4>
      <ol class="breadcrumb">
                                                                                  ...
                                                                                  <div class="card-body ">
                                                                                          <div class="from-group row justify-content-sm-center">
                                                                                                ...
                                                                                                <table>
                                                                                                    <tr>
                                                                                                      <td>
                                                                                                        <strong>NPL NET = </strong>
                                                                                                      </td>
                                                                                                      <td >
                                                                                                          <output>
                                                                                                            Baki Debet Kolektibilitas KL,D,M - Kolektibitas PPAP KL, D,M
                                                                                                            <hr>
...
<?php $this->view('ViewAccounting/js/dashboard_ratio_tambahan/dashboard_ratio_npl_net_js.php'); ?>
