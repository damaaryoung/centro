        ...
        <div class="modal-content">
                            ...
                            <div class="col-md-11 mx-auto">
                                ...
                                <form>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control form-control-sm" id="view_area_kerja"
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control form-control-sm" id="view_nomor_rekening"
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-2">
                                        <label class="control-label" style="padding-top: 5px;" for="inp_plafon">PLafon &
                                            Tenor</label>
                                    </div>
                                    <div class="col-sm-2">
                                        <input type="text" class="form-control form-control-sm" id="view_inp_plafon"
                                            name="inp_plafon" disabled>
                                    </div>
                                    <div class="col-sm-1">
                                        <input type="text" class="form-control form-control-sm" id="view_inp_tenor"
                                    ...
                                    <div class="col-sm-3">
                                        <input type="text" class="form-control form-control-sm"
                                            id="view_tanggal_realisasi" name="tanggal_realisasi" disabled>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-5 col-sm-2">
                                        <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist"
                                            ...
                                            <a class="nav-link active" id="view-vert-tabs-nasabah" data-toggle="pill"
                                                href="#view_tab-nasabah" role="tab" aria-controls="tab-nasabah"
                                                aria-selected="true">Nasabah</a>
                                            <a class="nav-link" id="vert-tabs-permohonan-kredit-tab" data-toggle="pill"
                                                href="#view_vert-tabs-permohonan-kredit" role="tab"
                                            ...
                                            <a class="nav-link" id="vert-tabs-tab-jaminan-tab" data-toggle="pill"
                                                href="#view_vert-tabs-jaminan" role="tab"
                                            ...
                                            <a class="nav-link" id="vert-tabs-bi-checking-tab" data-toggle="pill"
                                                href="#view_vert-tabs-bi-checking" role="tab"
                                                aria-controls="vert-tabs-settings" aria-selected="false">BI Checking</a>
                                            <a class="nav-link" id="vert-tabs-credit_analist-tab" data-toggle="pill"
                                                href="#view_vert-tabs-credit_analist" role="tab"
                                                aria-controls="vert-tabs-credit_analist" aria-selected="false">Credit
                                                Analist</a>
                                            <a class="nav-link" id="vert-tabs-legal-tab" data-toggle="pill"
                                                href="#view_vert-tabs-legal" role="tab" aria-controls="vert-tabs-legal"
                                                aria-selected="false">Legal</a>
                                            <a class="nav-link" id="vert-tabs-spk-tab" data-toggle="pill"
                                                href="#view_vert-tabs-spk" role="tab" aria-controls="vert-tabs-spk"
                                                aria-selected="false">SPK & NDK</a>
                                            <a class="nav-link" id="vert-tabs-foto-tab" data-toggle="pill"
                                                href="#view_vert-tabs-foto" role="tab" aria-controls="#vert-tabs-foto"
                                                aria-selected="false">Foto</a>
                                            <a class="nav-link" id="vert-tabs-release-tab" data-toggle="pill"
                                                href="#view_vert-tabs-release" role="tab"
                                                aria-controls="#vert-tabs-release" aria-selected="false">Release
                                                Asset</a>
                                            <a class="nav-link" id="vert-tabs-status-tab" data-toggle="pill"
                                                href="#view_vert-tabs-status" role="tab"
                                                aria-controls="#vert-tabs-status" aria-selected="false">Status</a>
                                        </div>
                                    </div>
                                    <div class="col-7 col-sm-9">
                                        <div class="tab-content" id="vert-tabs-tabContent">
                                            <!-- START NASABAH -->
                                            <div class="tab-pane text-left fade active show" id="view_tab-nasabah"
                                                role="tabpanel" aria-labelledby="view-vert-tabs-nasabah">
                                                    ...
                                                    <div class="card card-success " id="verifi_ktp">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                ...
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_nasabah"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                            ...
                                            <div class="tab-pane fade" id="view_vert-tabs-permohonan-kredit"
                                                role="tabpanel" aria-labelledby="vert-tabs-permohonan-kredit-tab">
                                                    ...
                                                    <div class="card card-success ">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_permohonan_kredit"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                                                <div class="col-sm-8" id="view_notes_permohonan_kredit">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- START JAMINAN -->
                                            <div class="tab-pane fade" id="view_vert-tabs-jaminan" role="tabpanel"
                                                aria-labelledby="vert-tabs-tab-jaminan-tab">
                                                    ...
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_jaminan"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="custom-file-view"
                                                            id="view_jaminan_pengakuan_hutang">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                            ...
                                            <!-- START BI CHECKING -->
                                            <div class="tab-pane fade" id="view_vert-tabs-bi-checking" role="tabpanel"
                                                aria-labelledby="vert-tabs-bi-checking-tab">
                                                    ...
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_bi_checking"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-sm-6">
                                                        ...
                                                        <div class="custom-file-view"
                                                            id="view_form_pengajuan_bi_checking">
                                                        </div>
                                                    </div>
                                                    <div class="form-group col-sm-6">
                                                        <label for="customFile">Form Persetujuan BI Checking</label>
                                                        <div class="custom-file-view"
                                                            id="view_form_persetujuan_bi_checking">
                                                        </div>
                                                    </div>
                                                    <!-- <div class="form-group col-sm-6">
                                            ...
                                            <div class="tab-pane fade" id="view_vert-tabs-credit_analist"
                                                role="tabpanel" aria-labelledby="vert-tabs-credit_analist-tab">
                                                    ...
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_credit_analist"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                                                <div class="col-sm-8" id="view_notes_credit_analist">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <!-- START LEGAL -->
                                            <div class="tab-pane fade" id="view_vert-tabs-legal" role="tabpanel"
                                                aria-labelledby="vert-tabs-legal-tab">
                                                ...
                                                <div class="col-md-12 form-verifikasi">
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8" id="view_status_verifikasi_legal">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                            ...
                                            <!-- START SPK & NDK -->
                                            <div class="tab-pane fade" id="view_vert-tabs-spk" role="tabpanel"
                                                aria-labelledby="vert-tabs-spk-tab">
                                                    ...
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8"
                                                                    id="view_status_verifikasi_spk_ndk"></div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label for="customFile">Surat Pernyataan Beda Tanggal Jatuh
                                                            Tempo</label>
                                                    ...
                                                    <div class="form-group col-sm-6">
                                                        <label for="customFile">Surat Pernyataan Tunggakan Bunga dan
                                                            Denda</label>
                                            ...
                                            <!-- START FOTO -->
                                            <div class="tab-pane fade" id="view_vert-tabs-foto" role="tabpanel"
                                                aria-labelledby="vert-tabs-foto-tab">
                                                ...
                                                <div class="col-md-12 form-verifikasi">
                                                    <div class="card card-success">
                                                        ...
                                                        <div class="card-body">
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Status </div>
                                                                <div class="col-sm-8" id="view_status_verifikasi_foto">
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-12" style="display: flex;">
                                                                <div class="col-sm-2">Notes </div>
                                            ...
                                            <!-- START RELEASE -->
                                            <div class="tab-pane fade" id="view_vert-tabs-release" role="tabpanel"
                                                aria-labelledby="vert-tabs-release-tab">
                                                <div class="row">
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="customFile">Tanda Serah Terima Aset Dokumen Dari
                                                                Bpr Kmi Ke Nasabah</label>
                                                            <div class="custom-file frm-release-asset">
                                                                <input type="file" class="custom-file-input"
                                                                    id="tanda_terima_ra" onchange='getImg(event)'>
                                                                <label class="custom-file-label"
                                                                    for="tanda_terima_ra">Choose file</label>
                                                            </div>
                                                            <div class="row custom-file-view" style="padding-top: 10px;"
                                                                id="file-tanda_terima_ra"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="customFile">Surat Kuasa Pengambilan Aset
                                                                Dokument (Jika di Kuasakan)</label>
                                                            <div class="custom-file frm-release-asset">
                                                                <input type="file" class="custom-file-input"
                                                                    id="surat_kuasa_ra" onchange='getImg(event)'>
                                                                <label class="custom-file-label"
                                                                    for="surat_kuasa_ra">Choose file</label>
                                                            </div>
                                                            <div class="row custom-file-view" style="padding-top: 10px;"
                                                                id="file-surat_kuasa_ra"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="customFile">Identitas Pengambilan Aset Dokument
                                                                (Nasabah Atau Pihak Yang Diberi Kuasa)</label>
                                                            <div class="custom-file frm-release-asset">
                                                                <input type="file" class="custom-file-input"
                                                                    id="identitas_pengambilan_ra"
                                                                    onchange='getImg(event)'>
                                                                <label class="custom-file-label"
                                                                    for="identitas_pengambilan_ra">Choose file</label>
                                                            </div>
                                                            <div class="row custom-file-view" style="padding-top: 10px;"
                                                                id="file-identitas_pengambilan_ra"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="custom-file frm-release-asset">
                                                                <input type="file" class="custom-file-input"
                                                                    id="lainnya_ra" onchange='getImg(event)'>
                                                                <label class="custom-file-label" for="lainnya_ra">Choose
                                                                    file</label>
                                                            </div>
                                                            <div class="row custom-file-view" style="padding-top: 10px;"
                                                                id="file-lainnya_ra"></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-12">
                                                        <div class="form-group">
                                                            <label for="customFile">Foto Serah Terima Aset Dokumen Dari
                                                                Bpr Kmi Ke Nasabah</label>
                                                            <div class="custom-file frm-release-asset">
                                                                <input type="file" class="custom-file-input"
                                                                    id="serah_terima_ra" onchange='getImg(event)'>
                                                                <label class="custom-file-label"
                                                                    for="serah_terima_ra">Choose file</label>
                                                            </div>
                                                            <div class="row custom-file-view" style="padding-top: 10px;"
                                                                id="file-serah_terima_ra"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <!-- START STATUS -->
                                            <div class="tab-pane fade" id="view_vert-tabs-status" role="tabpanel"
                                                aria-labelledby="vert-tabs-status-tab">
                                                <!-- START Perubahan Status -->
                                                <div class="col-md-12 form-verifikasi">
                                                    <div class="card card-info">
                                                        <div class="card-header">
                                                        ...
                                                        <div class="card-body">
                                                            <form>
                                                                <div class="form-group row">
                                                                    <label for="status_efiling"
                                                                        class="col-sm-4 col-form-label">Status
                                                                        Efiling</label>
                                                                    <div class="col-sm-8">
                                                                        <select class="custom-select my-1 mr-sm-2"
                                                                            id="inputStatusVerifikasi">
                                                                            <option selected>Pilih Perubahan Status
                                                                            </option>
            ...
            <div class="modal-footer">
                <button type="button" id="btn_close" class="btn btn-default" data-dismiss="modal"
                    onclick="closeViewEfiling()">Close</button>
