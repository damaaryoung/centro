                                    ...
                                    <div class="form-group row">
                                        <div class="col-5 col-sm-2">
                                          <div class="nav flex-column nav-tabs h-100" id="vert-tabs-tab" role="tablist" aria-orientation="vertical">
                                            <a class="nav-link active" id="vert-tabs-nasabah" data-toggle="pill" href="#vert-tab-nasabah" role="tab" aria-controls="tab-nasabah" aria-selected="true">Nasabah</a>
                                        ...
                                        <div class="col-7 col-sm-9">
                                          <div class="tab-content" id="vert-tabs-tabContent">
                                            <!-- START NASABAH -->
                                              <div class="tab-pane text-left fade active show" id="vert-tab-nasabah" role="tabpanel" aria-labelledby="nasabah">
                                                  ...
                                                  <div class="row">
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-ktp_all"></div>
                                                      </div>
                                                    </div>
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-kartu_keluarga"></div>
                                                      </div>
                                                    </div>
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-inp_npwp"></div>
                                                      </div>
                                                    </div>
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                    ...
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-surat_keterangan_desa"></div>
                                                      </div> 
                                                    </div>   
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                    ...
                                                    <div class='col-6'>
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-surat_keterangan_kerja"></div>
                                                      </div> 
                                                    </div>    
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-surat_keterangan_usaha"></div>
                                                      </div>
                                                    </div>  
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-rekening_koran"></div>
                                                      </div>
                                                    </div> 
                                                    <div class="col-6">
                                                      <div class="form-group">
                                                        ...
                                                        <div class="row" style="padding-top: 10px;" id="file-tdp_siup"></div>
                                                      </div>  
                                                    </div>   
                                                    <div class="col-6">
                                                      <div class="form-group">
                                          ...
                                          <!-- START PERMOHONAN KREDIT -->
                                              <div class="tab-pane fade" id="vert-tabs-permohonan-kredit" role="tabpanel" aria-labelledby="permohonan-kredit">
                                                ...
                                                <div class="col-md-12 form-verifikasi">
                                                  <div class="card card-success">
                                                    ...
                                                    <div class="card-body" id="verifikasi-option-permohonan-kredit"></div>
                                                  </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-aplikasi_permohonan_kredit"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-denah_lokasi"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-kelengkapan_dokumen_kredit"></div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                          ...
                                          <!-- START PERMOHONAN JAMINAN -->
                                              <div class="tab-pane fade" id="vert-tabs-jaminan" role="tabpanel" aria-labelledby="jaminan">
                                                ...
                                                <div class="row">
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_sertifikat"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_skmht"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_apht"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="jaminan_roya" dir="jaminan"
                                                          onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="jaminan_roya">Choose file Roya</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_roya"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_sht"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_pbb"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="jaminan_imb" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="jaminan_imb">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_imb"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_ajb"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_bpkb"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_fidusia"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_ahli_waris"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="jaminan_pengakuan_hutang">Choose file
                                                        </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_pengakuan_hutang"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_pengakuan_hak"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jaminan_addendum"></div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                          ...
                                          <!-- START PERMOHONAN BI CHECKING -->
                                              <div class="tab-pane fade" id="vert-tabs-bi-checking" role="tabpanel" aria-labelledby="bi-checking">
                                                  ...
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Form Pengajuan BI
                                                        Checking</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="pengajuan_bi_checking" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="pengajuan_bi_checking">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-pengajuan_bi_checking"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Form Persetujuan BI
                                                        Checking</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="persetujuan_bi_checking" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="persetujuan_bi_checking">Choose
                                                          file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-persetujuan_bi_checking"></div>
                                                    </div>
                                                  </div>
                                                  <!-- <div class="col-6">
                                                                                            <div class="form-group">
                                          ...
                                          <!-- START PERMOHONAN CREDIT ANALIST -->
                                              <div class="tab-pane fade" id="vert-tabs-credit_analist" role="tabpanel" aria-labelledby="credit">
                                                ...
                                                <div class="col-md-12 form-verifikasi">
                                                  <div class="card card-success">
                                                    ...
                                                    <div class="card-body" id="verifikasi-option-credit-analist"></div>
                                                  </div>
                                                </div>
                                                  ...
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Memorandum Account
                                                        Officer</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="credit_analist_memo_ao" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="credit_analist_memo_ao">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-credit_analist_memo_ao"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Memorandum Credit
                                                        Analist</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="credit_analist_memo_ca" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="credit_analist_memo_ca">Choose file
                                                        </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-credit_analist_memo_ca"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="offering_letter" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="offering_letter">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-offering_letter"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Form Verifikasi & Penilaian
                                                        Jaminan</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="verifikasi_penilaian" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="verifikasi_penilaian">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-verifikasi_penilaian"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="checklist_survey" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="checklist_survey">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-checklist_survey"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Credit Authority
                                                        Approval</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="persetujuan_kredit" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="persetujuan_kredit">Choose file</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-persetujuan_kredit"></div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                          ...
                                          <!-- START PERMOHONAN LEGAL -->
                                              <div class="tab-pane fade" id="vert-tabs-legal" role="tabpanel" aria-labelledby="legal">
                                                ...
                                                <div class="row">
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-pengajuan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-lpdk"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="check_pengikatan">Choose file Foto
                                                          Domisili</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-check_pengikatan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="oder_pengikatan">Choose file Foto
                                                          Usaha</label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-oder_pengikatan"></div>
                                                    </div>
                                                  </div>
                                                </div>  
                                              </div>
                                          ...
                                          <!-- START PERMOHONAN SPK & NDK -->
                                              <div class="tab-pane fade" id="vert-tabs-spk" role="tabpanel" aria-labelledby="spk_ndk">
                                                ...
                                                <div class="row">
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-spk"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-asuransi"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-spajk_spa_fpk"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Surat Pernyataan Tidak Ada
                                                        IMB</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="sp_no_imb" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="sp_no_imb">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-sp_no_imb"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-jadwal_angsuran"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="personal_guarantee" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="personal_guarantee">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-personal_guarantee"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-hold_dana"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_transfer"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_keabsahan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_jth_tempo"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_auth"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="custom-file">
                                                        ...
                                                        <label class="custom-file-label" for="srt_penyerahan_jaminan">Choose file
                                                        </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_penyerahan_jaminan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-denda"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-srt_aksep"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Tanda Terima Uang Oleh
                                                        Nasabah</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="tt_uang" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="tt_uang">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-tt_uang"></div>
                                                    </div>
                                                  </div>
                                                  <div class='col-6'>
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-pendebetan_rekening"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Surat Pernyataan ( Pemasangan )
                                                        Plang</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="sp_plang" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="sp_plang">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-sp_plang"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      <label for="customFile">Hal-hal yang diketahui Oleh
                                                        Nasabah</label>
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input" id="hal_penting" onchange='getImg(event)'>
                                                        <label class="custom-file-label" for="hal_penting">Choose file </label>
                                                      </div>
                                                      <div class="row" style="padding-top: 10px;" id="file-hal_penting"></div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
                                          ...
                                          <!-- START PERMOHONAN FOTO -->
                                              <div class="tab-pane fade" id="vert-tabs-foto" role="tabpanel" aria-labelledby="foto">
                                                ...
                                                <div class="row">
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-foto_jaminan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-foto_pengikatan"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-foto_domisili"></div>
                                                    </div>
                                                  </div>
                                                  <div class="col-6">
                                                    <div class="form-group">
                                                      ...
                                                      <div class="row" style="padding-top: 10px;" id="file-foto_usaha"></div>
                                                    </div>
                                                  </div>
                                                </div>
                                              </div>
