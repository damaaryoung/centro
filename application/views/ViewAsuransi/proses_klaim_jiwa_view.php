...
<script type="text/javascript" src="<?php echo base_url();?>assets/design/js/select2.full.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Proses Klaim Asuransi Jiwa
        <small></small>
      </h1>
      <ol class="breadcrumb">
                                  ...
                                  <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-2">
                                                      <label style="padding-top: 5px;" class="control-label">
                                                        <i class="fas fa-file"></i> <a href="" id="attachment_jiwa" target="_blank">File Upload</a>
                                                      </label>
                                                  </div>
                                  </div>
