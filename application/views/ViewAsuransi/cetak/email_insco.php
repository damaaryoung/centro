...
<html>
    <body>
        ...
        Berikut Kami Lampirkan data nasabah PT BPR Kredit Mandiri Indonesia yang akan mengajukan proses klaim asuransi:</p>
        <table><tr><td width="115">Nama Nasabah</td><td width="20px">:</td> <td><?php echo $nama_nasabah; ?></td> </tr>
            ...
            <tr><td width="115">Tgl Klaim</td><td width="20px">:</td><td width><?php echo $tgl_klaim;?></td></tr>
        </table>
        <p>File Attachment : </p>
        <?php echo $attach;?>
        <p>Terimakasih.
