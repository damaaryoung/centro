...
<script type="text/javascript" src="<?php echo base_url();?>assets/design/js/select2.full.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Pengajuan Refund Asuransi <?php if($this->session->userdata('pengajuan_refund') == '1'){ echo "Jaminan";}else { echo "Jiwa";}?>
        <small></small>
      </h1>
      <ol class="breadcrumb">
        ...
        <!-- From card Atas -->
          ...
          <div class="card card-danger">
                  ...
                  <div class="card-body">
                                    ...
                                    <div class="form-group row">
                                            <div class="col-sm-2">
                                                <button type="button" class="btn btn-success btn-sm" 
                                                        ...
                                                        data-toggle="modal"  data-backdrop="static" <?php if($this->session->userdata('pengajuan_refund') == '1'){ echo "data-target='#modal_pengajuan_refund_jaminan'";}else { echo "data-target='#modal_pengajuan_refund_jiwa'";}?>>
                                                          <i class="fas fa-plus-circle"></i> Pengajuan Refund Asuransi <?php if($this->session->userdata('pengajuan_refund') == '1'){ echo "Jaminan";}else { echo "Jiwa";}?>
                                                </button>
                                            </div>
                                            <div class="col-sm-8">
                                            </div>
                                ...
                                <div class="table-responsive">
                                    <table id="tbl_pengajuan_refund" class="table table-striped table-bordered" style="width:100% text-align:center" >
                                        ...
                                        <tbody id="table_body_pengajuan_refund">
                                        </tbody>
                                    </table>
                                </div>
                                <br>    
            ...
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Pengajuan Refund Asuransi Jaminan</h4>
                              ...
                              <div class="col-md-12 mx-auto">
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" id="modal_jenis_refund_jaminan" name="modal_jenis_refund_jaminan">
                                                        <!-- <select class="form-control form-control-sm" id="modal_jenis_refund_jaminan" name="modal_jenis_refund_jaminan">
          ...
          <div class="modal fade" id="modal_pengajuan_refund_jiwa">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Pengajuan Refund Asuransi Jiwa</h4>
                ...
                <div class="row">
                              ...
                              <div class="col-md-12 mx-auto">
                                  ...
                                  <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" id="modal_jenis_refund_jiwa" name="modal_jenis_refund_jiwa">
                                                        <!-- <select class="form-control form-control-sm" id="modal_jenis_refund_jiwa" name="modal_jenis_refund_jiwa">
                                                          <option value="Kebakaran">Kebakaran</option>
                                                          <option value="Meninggal Dunia">Meninggal Dunia</option>
                                                          <option value="Ketidakmampuan Tetap">Ketidakmampuan Tetap</option>
                                                          <option value="Kehilangan">Kehilangan</option>
          ...
          <div class="modal fade" id="modal_pengajuan_refund_jaminan_update"> 
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Update Pengajuan Refund Asuransi Jaminan</h4>
                              ...
                              <div class="col-md-12 mx-auto">
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-2">
                                                      <label style="padding-top: 5px;" class="control-label" for="modal_jenis_refund_jaminan_update">Jenis Refund</label>
                                                  </div>
                                                  <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" id="modal_jenis_refund_jaminan_update" name="modal_jenis_refund_jaminan_update">
                                                        <!-- <select class="form-control form-control-sm" id="modal_jenis_refund_jaminan_update" name="modal_jenis_refund_jaminan_update">
                                                        </select> -->
                                                  </div>
                                  </div>
                                  <div class="form-group row">
          ...
          <div class="modal fade" id="modal_pengajuan_refund_jiwa_update">
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Update Pengajuan Refund Asuransi Jiwa</h4>
                ...
                <div class="row">
                              ...
                              <div class="col-md-12 mx-auto">
                                  ...
                                  <div class="form-group row">
                                                  ...
                                                  <div class="col-sm-2">
                                                      <label style="padding-top: 5px;" class="control-label" for="modal_jenis_refund_jiwa_update">Jenis Refund</label>
                                                  </div>
                                                  <div class="col-sm-4">
                                                        <input type="text" class="form-control form-control-sm" id="modal_jenis_refund_jiwa_update" name="modal_jenis_refund_jiwa_update">
                                                        <!-- <select class="form-control form-control-sm" id="modal_jenis_refund_jiwa_update" name="modal_jenis_refund_jiwa_update">
                                                        </select> -->
                                                  </div>
                                  </div>
                                  <div class="form-group row">
...
<?php $this->view('ViewAsuransi/js/pengajuan_refund_js.php'); ?>
<style>
              /* Important part */
              .modal-dialog{
