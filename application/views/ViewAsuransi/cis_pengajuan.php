...
<script type="text/javascript" src="<?php echo base_url();?>assets/design/js/select2.full.min.js"></script>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> <img src="<?= base_url(); ?>assets/dist/img/rekap_asuransi.svg" width="5%"> Pengajuan Asuransi CIS
        <small></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="content container-fluid">
        ...
        <!-- From card Atas -->
                                              ...
                                              <div class="col-sm-5">
                                                  <button type="button" class="btn btn-success btn-sm" 
                                                          style="width: 250px;" id="btn_pengajuan">
                                                            <i class="fas fa-plus-circle"></i> Pengajuan Asuransi CIS
                                                  </button>
                                              </div>
                                              <div class="col-sm-5">
                                              </div>
          ...
          <div class="modal fade" id="modal_pengajuan_klaim_cis"> 
            <div class="modal-dialog modal-xl">
              <div class="modal-content">
                <div class="modal-header">
                  <h4 class="modal-title">Pengajuan Asuransi Cash In Save</h4>
                ...
                <div class="row" style="padding-top: 20px;">
                              ...
                              <div class="col-md-12 mx-auto">
                                  <div class="form-group row">
                                                <div class="col-sm-2">
                                                    <label style="padding-top: 5px;" class="control-label" for="modal_nama_asuransi">Nama Asuransi</label>
                                                </div>
                                                <div class="col-sm-4">
                                                    <select class="form-control form-control-sm select2 custom-select" 
                                                            id="modal_nama_asuransi" name="modal_nama_asuransi" style="width: 300px;">
                                                    </select>
                                                </div>
                                                <div class="col-sm-2">
                                                    <label class="control-label" style="padding-top: 5px;"  for="modal_limit_kas">Limit Kas Utama</label>
                                                </div>
                                                <div class="col-sm-4">
                                                      <input type="text" class="form-control form-control-sm" id="modal_limit_kas" name="modal_limit_kas">
                                                </div>
                                  </div>
                                  <div class="form-group row">
                                                <div class="col-sm-2">
                                                ...
                                                <div class="col-sm-2">
                                                    <label class="control-label" style="padding-top: 5px;"  for="modal_saldo_akhir_kas">Saldo Akhir Kas Utama</label>
                                                </div>
                                                <div class="col-sm-4">
                                                      <input type="text" class="form-control form-control-sm" id="modal_saldo_akhir_kas" name="modal_saldo_akhir_kas">
                                                </div>
                                  </div>
                                  <div class="form-group row">
                                                <div class="col-sm-2">
                                  ...
                                  <!-- <div class="form-group row">
                                                  <div class="col-sm-2">
                                                      <label class="control-label" style="padding-top: 5px;"  for="modal_upload_jaminan">Attachment</label>
                                                  </div>
                                                  <div class="col-sm-4">
                                                    <div class="form-group">
                                                      <div class="custom-file">
                                                        <input type="file" class="custom-file-input form-control form-control-sm" id="modal_upload">
...
<?php $this->view('ViewAsuransi/js/cis_pengajuan_js.php'); ?>
<style>
              /* Important part */
              .modal-dialog{
