                  ...
                  <div class="row">
                      ...
                      <!-- MAIN FORM -->
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-2">
                                      <select class="form-control" id="sertVerifikasi" name="sertVerifikasi">
                                      </select>
                                  </div>
                              </div>                         
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                      <select class="form-control" id="sertKantorLokasi" name="sertKantorLokasi" readonly>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                      <select class="form-control " id="sertKodeJenisAgunan" name="sertKodeJenisAgunan" readonly>
                                                <option value="" selected disabled hidden>Silahkan Pilih</option>
                                      </select>
                                  </div>
                              </div>
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-7">
                                    <select class="form-control " id="sertKodeIkatanAgunan" name="sertKodeIkatanAgunan" readonly>
                                        <option value="" selected disabled hidden>Silahkan Pilih</option>
                                    </select>
                                  </div>
                              </div>
                ...
                <div class="row">
                      ...
                      <br><br>
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-3">
                                        <select class="form-control " id="sertJenisSertifikat" name="sertJenisSertifikat" readonly>
                                        </select>
                                  </div>
                                  <div class="col-sm-2">
            ...
            <div id="DataLampiranSertifikat" class="tabcontent">
                ...
                <div class="row">
                      ...
                      <br><br>
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokAJB" name="sertDokAJB" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokIMB" name="sertDokIMB" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokSPPT" name="sertDokSPPT" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokSKHMT" name="sertDokSKHMT" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokDenah" name="sertDokDenah" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokRoya" name="sertDokRoya" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokSHT" name="sertDokSHT" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokSTTS" name="sertDokSTTS" readonly>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-2">
                                    <select class="form-control " id="sertDokSSB" name="sertDokSSB" readonly>
