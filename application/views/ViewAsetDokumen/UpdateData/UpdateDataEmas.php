<!-- Modal -->
<div class="modal fade" id="updateEmas" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <!-- END Data Emas -->
             ...
             <!-- Start SID -->
            <div id="SIDEmas" class="tabcontent">
                <div class="row">
