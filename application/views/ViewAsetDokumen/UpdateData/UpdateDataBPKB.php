<!-- Modal -->
<div class="modal fade" id="updateBPKB" tabindex="-1" role="dialog" data-backdrop="static" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    ...
                    <div class="row">
                            <div class="col-md-10 mx-auto">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-2">
                                            <input class="form-control" id="bpkbVerifikasi" name="bpkbVerifikasi" disabled>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-2">
