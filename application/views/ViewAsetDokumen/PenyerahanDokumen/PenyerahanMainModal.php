           ...
           <div class="row">
                  <div class="col-md-11 mx-auto">
                             <div class="form-group row">
                                  ...
                                  <div class="col-sm-3">
                                    <input class="form-control" id="mainVerifikasiPenyerahan" name="mainVerifikasiPenyerahan" disabled>
                                  </div>
                              </div>                                
                              <div class="form-group row">
                                  <div class="col-sm-2">
                                  ...
                                  <div class="col-sm-5">
                                    <select class="form-control" id="mainAreaKerjaPenyerahan" name="mainAreaKerjaPenyerahan" required>
                                    </select>
                                  </div>
                                  <div class="col-sm-1">
                              ...
                              <div class="form-group row">
                                  ...
                                  <div class="col-sm-3">
                                        <select class="form-control" id="mainTransaksiPenyerahan" name="mainTransaksi" readonly>
                    ...
                    <table id="" class="table table-striped table-bordered display" style="width:100%">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a type="button" data-toggle="modal" data-target="#penyerahanBPKBModal"
                                        class="btn btn-primary btn-sm" id="btnPenyerahanBPKB" style="width: 150px; color:white;">  
                      ...
                      <table id="" class="table table-striped table-bordered display" style="width:100%">
                          ...
                          <tbody>
                              <tr>
                                  ...
                                  <td><a type="button" data-toggle="modal" data-target="#penyerahanSertifikatModal"
                                        class="btn btn-primary btn-sm" id="btnPenyerahanSertif" style="width: 150px; color:white;">  
                                        <i class="fas fa-info-circle"></i> Detail</a></td>
                              </tr>
                          </tbody>
                      </table>
