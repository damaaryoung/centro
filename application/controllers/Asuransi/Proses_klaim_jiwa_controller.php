...
class Proses_klaim_jiwa_controller extends CI_Controller {
	...
	public function proses_upload_reject(){
		...
		if(isset($_FILES["files"])){
			...
			if (!file_exists("$root_document/public_centro/$rekening/klaim_asuransi_jiwa")) {
				mkdir("$root_document/public_centro/$rekening/klaim_asuransi_jiwa");
			}

 
			$config['upload_path']   = "$root_document/public_centro/$rekening/klaim_asuransi_jiwa";
			...
			if(!$this->upload->do_upload('files') ){
				...
				$pathFile = "public_centro/$rekening/klaim_asuransi_jiwa/";
