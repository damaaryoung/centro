...
class Update_Kirim_Jaminan_Verifikasi_Controller extends CI_Controller {
	public function __construct() {
        parent:: __construct();
        $this->load->model('CustodianModel/update_kirim_jaminan_verifikasi_model');
	...
	public function index()
	{
		...
		if($session != ''){ 
			$data['selectKodeKantor'] = $this->update_kirim_jaminan_verifikasi_model->selectKodeKantor();
			$this->load->view('ViewCustodian/update_kirim_jaminan_verifikasi_centro.php', $data);
		}
		else{
	...
	// 		$list_request_jaminan = $this->update_kirim_jaminan_verifikasi_model->list_request_jaminan($kode_kantor);
	...
	// 		$listJaminanSearch = $this->update_kirim_jaminan_verifikasi_model->listJaminanSearch($search,$kode_kantor);
